        ...
        do {
            ...
            switch (opc2) {
                case 1:
                    ...
                    String nome = s.nextLine();
                    for (int i = 0; i < showalrf.length; i++) {
                        if(showalrf[i] != null && showalrf[i].getRefeicao().getNomeRefeicao().equalsIgnoreCase(nome)){
                            System.out.println(showalrf[i].getAlimento());
                        }
                    }
